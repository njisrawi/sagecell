...
if __name__ == "__main__":
    ...
    app = SageCellServer(baseurl=args.baseurl)
    ...
    def handler(signum, frame):
        ...
        # FIXME: probably something else should be done with the completer
        app.completer.kernel.channels["shell"].on_recv(None)
        app.completer.kernel.stop()
